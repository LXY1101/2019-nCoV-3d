...
// import retData from "@/mock/ret.json" // 中国分区
// import worldRetData from "@/mock/worldRet.json" //世界分区
// import provinceData from "@/mock/province.json" //省份分区
// post请求头
...
class DataServer {
    ...
    loadChinaOverall(ut) {
            return new Promise((resolve, reject) => {
                ...
                //                 };
                //                 console.log(JSON.stringify(ret),'ret1111')
                //                 resolve(ret);
                //             }
    ...
    getHistoryDays() {
        ...
        return new Promise((resolve, reject) => {
            ...
            //     else {
                    ...
                    // console.log(data[data.length - 1].updateTime,'start')
